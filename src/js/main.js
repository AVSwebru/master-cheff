...
import './cartMove';
import Spoiler from './filter-spoiler';
...
var spoilerFilterArr = document.querySelectorAll('.js-filter-type');

spoilerFilterArr.forEach((element) => new Spoiler(element).init());
